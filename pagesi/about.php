    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6 mb-4">
                <div class="card text-center h-100">
                    <img src="../assets/images/doctor.jpg" alt="Team Member" class="card-img-top">
                    <div class="card-body">
                        <h5 class="card-title">Dr. Akwa Gilbert Mua</h5>
                        <p class="card-text text-muted">Executive Director</p>
                    </div>
            ...
            <div class="col-lg-4 col-md-6 mb-4">
                <div class="card text-center h-100">
                    <img src="../assets/images/emma.jpg" alt="Team Member" class="card-img-top">
                    <div class="card-body">
                        <h5 class="card-title">Dr. Ateh Cavour</h5>
                        <p class="card-text text-muted">Field Agent</p>
                    </div>
            ...
            <div class="col-lg-4 col-md-6 mb-4">
                <div class="card text-center h-100">
                    <img src="../assets/images/rev.jpg" alt="Team Member" class="card-img-top">
                    <div class="card-body">
                        <h5 class="card-title">Fon Blaise Fru</h5>
                        <p class="card-text text-muted">Media Manager</p>
                    </div>
